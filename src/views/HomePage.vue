  ...
  <div class="container mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4">
      <div
        ...
        :key="pokemon.id"
        :class="['shadow-md', 'rounded', 'p-4', 'text-center', bgColor(pokemon.id)]"
      >
        <router-link :to="{ name: 'PokemonDetails', params: { name: pokemon.name } }">
          <img :src="getPokemonImageUrl(pokemon.id)" :alt="pokemon.name" class="w-24 h-24 object-cover mb-2 mx-auto" />
